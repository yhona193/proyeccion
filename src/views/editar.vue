<template>
    <content-header title="Datos Generales" />
    <content>
                    ...
                    <div class="card card-info card-outline card-tabs">
                        <div class="card-header p-0 pt-1 border-bottom-0">
                            <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" id="custom-tabs-three-messages-tab" data-toggle="pill"
                                        href="#informes" role="tab" aria-controls="informes"
                                        aria-selected="false">
                                        <font style="vertical-align: inherit;">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <div class="form group mt-2">
                                                    ...
                                                    <input type="text" id="grupModalidad" class="form-control" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                        ...
                                        <div class="col-sm-12 mt-2 mb-4">
                                            ...
                                            <div class="table-responsive">
                                                <table id="TablaInformes" class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        <tr v-for="informe in informes" :key="informe.infoId">
                                                            <td>{{ informe.infoFechPre }}</td>
                                                            <td>{{ informe.infoObs}}</td>
                                                            
                                                            <td>
                                                                <div v-if="informe.infoEst > 0">
                                                                    <button
                                                                        class="btn  btn-sm btn-success">Activo</button>
                                                                </div>
                                                                <div v-else>
                                                            ...
                                                            <td><button type="button"
                                                                    class="btn btn-warning btn-sm mr-1 rounded-circle"
                                                                    v-on:click="EditarInf(informe.infoId)"><i
                                                                        class='fas fa-pencil-alt'></i></button>
                                                                <button type="button"
                                                                    class="btn btn-danger btn-sm mr-1 rounded-circle"
                                                                    v-on:click="EliminarInf(grupo.infoId)"><i
                                                                        class='fas fa-trash'></i></button>
                                                            </td> 
                                                        </tr>
                                                    </tbody>
                ...
                <div class="col-lg-4 hidden-md hidden-sm hidden-xs">
                    <div class="card card-outline card-info shadow">
                        ...
                        <div class="card-body">
                            <div class="col-sm-12">
                                <div class="input-group input-group mb-3">
                                    <select class="form-control" id="inf">
                                        <option value="primerAvance">Informe de Avance</option>
                                        <option value="segundoAvance">Informe Final</option>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="col-sm-12">
                                <div class="mt-4 mb-2">
                                    <button type="button" class="btn btn-success btn-sm btn-block"
                                    @click="GuardarAvance()">Guardar Cambios</button>
                                </div>
                            </div>
    ...
    methods: {
        async GuardarAvance(){
            try{
                ...
                params.append('grupId', this.grupoId);
                params.append('infoFechPre', $("#fechaPresentacion").val());
                params.append('infoEst', true);
                
                let result = await axios.post(`https://apirest.upla.edu.pe/proyeccion/informeAvance`, params);
                console.log(result);
                this.Alerta('success', 'Éxito!', 'Su registro se realiazo correctamente.')

                this.informesAvance();

            }catch(error){
                console.log(error)
                this.Alerta('error', 'Error!', 'No se registraron correctamente.')
            }  
        }
        ,
        EliminarEst(id){
            try {
                ...
                confirmButtonText: 'Si, eliminarlo!'
                    ...
                    let url =  `https://apirest.upla.edu.pe/proyeccion/integrantes?id=${id}&nameId=detGruId`;
        ...
        async guardarObservacion(){
            try{
                ...
                let result = await axios.put(`https://apirest.upla.edu.pe/proyeccion/integrantes?id=${this.codId}&nameId=detGruId`, params);
                console.log(result);
        ...
        async informesAvance() {
            try {
                this.grupoId = this.$route.params.id;
                let response = await axios.get(`https://apirest.upla.edu.pe/proyeccion/informeavance?linkTo=grupId&equalTo=${this.grupoId}`)
        ...
        async estudiantesGrupo() {
            try {
                this.grupoId = this.$route.params.id;
                let response = await axios.get(`https://apirest.upla.edu.pe/proyeccion/integrantes?linkTo=grupId&equalTo=${this.grupoId}`)
        ...
        async Obtener() {
            ...
            let response = await axios.get(`https://apirest.upla.edu.pe/proyeccion/grupo?linkTo=grupId&search=${this.codigo}`)
            ...
            $("#grupModalidad").val(data.grupModalidad);
        ...
        async Guardar() {
            try {
                ...
                let result = await axios.put(`https://apirest.upla.edu.pe/proyeccion/grupo?id=${id}&nameId=grupId`, params);
                console.log(result);
